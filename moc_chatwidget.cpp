...
static const char qt_meta_stringdata_ChatWidget[] = {
    "ChatWidget\0\0on_pushButton_released()\0"
    "sendID,context\0updateWin(int,char*)\0"
};
...
void ChatWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateWin((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< char*(*)>(_a[2]))); break;
        default: ;
        }
    }
}
